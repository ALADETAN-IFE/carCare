    ...
    <>
                ...
                selectedService === 1 || bookingInputsObject?.serviceType == "Pickup & Delivery" ?
                  ...
                  <div className="picksCircle"
                    onClick={() => {
                      ...
                      setbookingInputsObject({ ...bookingInputsObject, serviceType: "Pickup & Delivery" })
                    }}
                  ></div>
              }
              <p>Pickup & Delivery</p>
          ...
          bookingInputsObject?.serviceType == "Pickup & Delivery" ?
            <div className='pickupLocation'>
              ...
              <input type="text"
               ...
               onChange={(e) => setbookingInputsObject({...bookingInputsObject,
      ...
      <div className="preAndNextBtn">
        ...
        <button className='addBooking_btn'
          // onClick={() => setbookingInputsObject({})}
         onClick={openConfirm}
        >Book Now</button>
      </div>
    </>
